export const swaggerSpec = {
  ...
  paths: {
    ...
    '/api/expenses/{id}': { patch: { summary: 'Atualiza gasto' }, delete: { summary: 'Remove gasto' } },
    '/api/purchases': { get: { summary: 'Lista compras' }, post: { summary: 'Cria compra e atualiza estoque' } },
    '/api/purchases/{id}': { delete: { summary: 'Remove compra' } },
    '/api/stock-items': { get: { summary: 'Lista estoque' }, post: { summary: 'Cria item de estoque' } },
    '/api/stock-items/{id}': { patch: { summary: 'Atualiza item de estoque' }, delete: { summary: 'Remove item de estoque' } },
